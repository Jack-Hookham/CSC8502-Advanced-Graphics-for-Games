...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=mountainsTest2&box=-110.499283,44.058759,-111.249309,43.519777
...
-----------
  ...
  * mountainsTest2 Height Map (ASTER 30m).png
  ...
  * mountainsTest2 Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * mountainsTest2 Height Map (SRTM3 v4.1).png
  ...
  * mountainsTest2 Height Map (SRTM30 Plus).png
  ...
  * mountainsTest2 Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 1676m (actual) is equal to 40m in
