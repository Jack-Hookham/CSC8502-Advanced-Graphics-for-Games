...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=grandCanyon2&box=-112.076756,36.116812,-112.165718,36.044947
...
-----------
  ...
  * grandCanyon2 Height Map (ASTER 30m).png
  ...
  * grandCanyon2 Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * grandCanyon2 Height Map (SRTM3 v4.1).png
  ...
  * grandCanyon2 Height Map (SRTM30 Plus).png
  ...
  * grandCanyon2 Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 719m (actual) is equal to 40m in
