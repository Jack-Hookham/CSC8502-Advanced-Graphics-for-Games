...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=pompeii2&box=14.667641,41.000444,14.191526,40.641120
...
-----------
  ...
  * pompeii2 Height Map (ASTER 30m).png
  ...
  * pompeii2 Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * pompeii2 Height Map (SRTM3 v4.1).png
  ...
  * pompeii2 Height Map (SRTM30 Plus).png
