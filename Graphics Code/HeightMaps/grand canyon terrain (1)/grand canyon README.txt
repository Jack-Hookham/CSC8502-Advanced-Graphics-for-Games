...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=grand+canyon&box=-111.827349,36.388537,-111.916621,36.316672
...
-----------
  ...
  * grand canyon Height Map (ASTER 30m).png
  ...
  * grand canyon Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * grand canyon Height Map (SRTM3 v4.1).png
  ...
  * grand canyon Height Map (SRTM30 Plus).png
  ...
  * grand canyon Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 830m (actual) is equal to 40m in
