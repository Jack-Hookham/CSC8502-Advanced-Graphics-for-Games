...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=mountainsTest&box=-110.520999,43.964807,-111.020225,43.605483
...
-----------
  ...
  * mountainsTest Height Map (ASTER 30m).png
  ...
  * mountainsTest Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * mountainsTest Height Map (SRTM3 v4.1).png
  ...
  * mountainsTest Height Map (SRTM30 Plus).png
  ...
  * mountainsTest Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 1931m (actual) is equal to 40m in
