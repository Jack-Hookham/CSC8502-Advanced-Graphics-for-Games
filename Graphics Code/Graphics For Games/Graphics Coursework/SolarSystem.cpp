...
{	
	...
	planeSouth->SetModelScale(Vector3(1500.0f, 1500.0f, 1.0f));
	//sun->SetModelScale(Vector3(10.0f, 10.0f, 10.0f));
	...
	planeNorth->SetModelScale(Vector3(1500.0f, 1500.0f, 1.0f));
	//sun->SetModelScale(Vector3(10.0f, 10.0f, 10.0f));
	...
	planeEast->SetModelScale(Vector3(1500.0f, 1500.0f, 1.0f));
	//sun->SetModelScale(Vector3(10.0f, 10.0f, 10.0f));
	...
	planeWest->SetModelScale(Vector3(1500.0f, 1500.0f, 1.0f));
	//sun->SetModelScale(Vector3(10.0f, 10.0f, 10.0f));
