...
{	
	...
	sun = new SolarObject(createSphereObj(), Vector4(0.9f, 0.7f, 0.3f, 1.0f), SOLAR_TYPE_SUN);
	sun->SetModelScale(Vector3(100.0f, 100.0f, 100.0f));
	sun->SetTransform(Matrix4::Translation(Vector3(0.0f, 0.0f, 0.0f)));
	AddChild(sun);

	planet = new SolarObject(createSphereObj(), Vector4(0.2f, 0.7f, 0.9f, 1.0f), SOLAR_TYPE_PLANET);
	planet->SetModelScale(Vector3(20.0f, 20.0f, 20.0f));
	planet->SetTransform(Matrix4::Translation(Vector3(300.0f, 0.0f, 0.0f)));
	sun->AddChild(planet);

	planet2 = new SolarObject(createSphereObj(), Vector4(0.2f, 0.9f, 0.7f, 1.0f), SOLAR_TYPE_PLANET);
	...
	ring = new SolarObject(ringMesh, Vector4(0.5, 0.2, 0.7, 1.0), SOLAR_TYPE_RING);
	...
	moon = new SolarObject(createSphereObj(), Vector4(0.4f, 0.4f, 0.4f, 1.0f), SOLAR_TYPE_MOON);
